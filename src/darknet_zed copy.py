...
left_img_pub = pub = rospy.Publisher('/camera/left/image_raw', Image, queue_size=10)
right_img_pub = pub = rospy.Publisher('/camera/right/image_raw', Image, queue_size=10)
...
def main(argv):
    ...
    weight_path = darknet_path + "weights/yolov3-tiny.weights"
