...
def main(argv):
    ...
    print("Camera calibration: The calibration/rectification process, called during sl::Camera::. most of the stereo parameters (except Baseline of course) should be 0 or very close to 0.")

    print("baseline", calibration_params.get_camera_baseline())
